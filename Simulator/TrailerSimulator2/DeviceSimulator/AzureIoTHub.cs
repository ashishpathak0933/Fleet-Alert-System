...
namespace DeviceSimulator
{
    public static class AzureIoTHub
    {
        ...
        private static string hubSharedAccessKey = "dZHmLzcwFxZkKAarqyMzbGTzIdCV64OYQcZpQiB21fQ"; //
        private static string device1Name = "trailer_sensor_11111101";
        private static string device1SharedAccessKey = "fbZeyljLdJIdF+xcepfaJt8XIXb01Hx4pRE+/PQBPGw=";
        ...
        private static string deviceId = device2Name;
